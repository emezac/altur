...
| [`api_contract_findings.md`](docs/api_contract_findings.md) | **New** — CALL-E returns transcript (not audio) verified vs the OpenAPI + a real call; the provider-agnostic `POST /api/v1/calls/webhook` ingestion decision |
